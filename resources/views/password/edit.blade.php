<x-app-layout>
  ...
  <form id="password-form" method="POST" action="{{ route('password.update', $password) }}">
      @csrf
      @method('PATCH')
      <div class="container">
          <div class="card">
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                              id="name" aria-describedby="name-error" value="{{$password->name}}">
                          @error('name')
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control @error('password') is-invalid @enderror"
                              name="password" id="password" aria-describedby="password-error" value="{{$passwordshow}}">
                          @error('password')
